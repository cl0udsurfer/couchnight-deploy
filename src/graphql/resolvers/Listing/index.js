...
const verifyHostListingInput = ({ title, description, price, }) => {
    if (title.length > 100) {
...
exports.listingResolvers = {
    Query: {
        ...
        listings: (_root, { location, filter, limit, page }, { db }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                if (location) {
                    const geoLocation = yield api_1.Google.geocode(location);
    ...
    Mutation: {
        hostListing: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const geoLocation = yield api_1.Google.geocode(input.address);
            ...
            const insertResult = yield db.listings.insertOne(Object.assign(Object.assign({ _id: new mongodb_1.ObjectId() }, input), { image: [{ url: imageUrl }], bookings: [], bookingsIndex: {}, country,
                admin,
                city, location: { lat, lng }, host: viewer._id }));
